...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gbbmdh0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gbbmdh0.containers.anotherwebservice.com/
...
```
git clone git@github.com:igor04091968/container-gbbmdh0.git
cd container-gbbmdh0
```
...
```
docker attach container-gbbmdh0
```
